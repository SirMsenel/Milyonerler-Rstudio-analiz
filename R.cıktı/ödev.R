...
pasta_grafigi <- pie(regionsa, labels = etiketler, main = "Pasta Grafi�i", col = rainbow(length(veri)))
...
# Temel istatistiksel �zetleme
summary(veri$age)

# Ya�lar�n histogram�
hist(veri$age, main = "Ya� Da��l�m�", xlab = "Ya�", ylab = "Frekans", col = "orange")


# Ya�lar� belirli aral�klara grupland�rarak tablo olu�tur
...
# Cinsiyetlere g�re grupland�rarak istatistiksel �zetleme
summary(veri$age)
summary(veri$gender)
...
cat("Erkek say�s�:", erkek_sayisi, "\n")
cat("Kad�n say�s�:", kadin_sayisi, "\n")



# Cinsiyetlere g�re ya�lar�n kutu grafi�i
boxplot(age ~ gender, data = veri, main = "Cinsiyetlere G�re Ya� Da��l�m�", xlab = "Cinsiyet", ylab = "Ya�", col = c("skyblue", "lightpink"))
...
etiketler <- paste(etiketler, "\n", round(yuzdeler, 1), "%\n", selfmades, "ki�i", sep = "")
pasta_grafigi <- pie(selfmades, labels = etiketler, main = "Pasta Grafi�i", col = c("orange","purple"))
...
# finalWorth vekt�r�n� temizlenmi� gdp_country vekt�r�yle ayn� boyuta getir
